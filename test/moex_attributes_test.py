...
ACTIONS_ATTRIBUTES = mc.MOEXRequestAttributes(
    "SBER", from_date=FIRST_DATE, till_date=SECOND_DATE
)
BONDS_ATTRIBUTES = mc.MOEXRequestAttributes(
    "SU26209RMFS0", from_date=FIRST_DATE, till_date=SECOND_DATE
)
CURRENCY_ATTRIBUTES = mc.MOEXRequestAttributes(
    "USD000000TOD", from_date=FIRST_DATE, till_date=SECOND_DATE
)
